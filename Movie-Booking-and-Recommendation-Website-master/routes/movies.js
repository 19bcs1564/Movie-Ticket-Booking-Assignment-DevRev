...
router.post("/movie/create",isAdmin,function(req,res)
{
	...
	var date=req.body.release;
	var summary=req.body.summary;
	var release=req.body.release;
	var duration=req.body.duration;

	var newmovie={name:name,img:img,ratings:ratings,director:director,date:date,theatre:theatre,summary:summary,release:release,duration:duration};
